...
> **Status:** Long-term product vision and design document  
> **Scope:** Defines how InLinkr works as a multi-product platform and how each product preserves its own identity.  
> **Constraint:** No code changes, database migrations, route changes, or branding changes are prescribed in this phase. The existing TubeLinkr production application remains untouched and continues as the reference implementation.
...
InLinkr is the platform. Every product built on it — starting with TubeLinkr and QRLinkr — is an independent application that shares one account, one billing system, one authentication system, and one analytics engine.

A user should never feel trapped inside a single generic dashboard. They should feel like they are opening a suite of professional tools that happen to share a single platform account.

Think **Adobe Creative Cloud**, **Atlassian**, or **Microsoft 365**:

- One account.
- One bill.
- One place to sign in.
- Many specialized applications, each with its own purpose, personality, and workflows.
...
### 2.1 app.inlinkr.com is the front door
...
TubeLinkr
Track YouTube traffic and prove creator impact

QRLinkr
Create, brand, and track QR codes
...
### 2.3 Design principles for the InLinkr Home
...
### 3.1 Each product is a dedicated application
...
### 3.2 Example TubeLinkr workspace
...
## 4. Product vs. Platform Responsibilities

### 4.1 InLinkr owns the platform layer
...
### 4.2 Each product owns the experience layer
...
## 5. Navigation and Product Switching

### 5.1 Always available product switcher
...
### 5.2 Returning to the InLinkr Home
...
### 6.2 The platform shell is neutral
...
### 8.4 Referrals apply across the platform
...
## 10. Redirects and Links

### 10.1 go.inlinkr.com is the platform redirect engine

The redirect engine is shared. It resolves short URLs, records events, and routes to destinations.

### 10.2 Product-agnostic links
...
### 10.3 Product-specific redirect rules
...
See `PLATFORM_SCHEMA_V1.md` for the technical blueprint.

### 12.2 Independent on top
...
## 13. Preserving TubeLinkr

### 13.1 Current TubeLinkr remains the reference
...
### 13.2 Platform work happens in the InLinkr project
...
### 13.4 The Keep Existing Constraint
...
### 14.1 Adding a product is a design decision, not a platform rewrite
...
### 14.2 Examples of future products
